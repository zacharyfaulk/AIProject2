...
{
    public partial class P2_GUI : Form
    {
        ...
        public P2_GUI(newCity[] cityArray, List<int> iList, int n)
        {
            _iList = iList;
        ...
        public void P1_GUI_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int d = 1; d < _iList.Count; d++)
            {
                ...
                cityLabel.Location = new Point (x1Int - 20, y1Int - 7);
                cityLabel.Text = "City " + _cityArray[xy1].id;
                ...
                //Create label for the final city
                if (d == _iList.Count - 1)
                {
                    int x2Int = Convert.ToInt32(x2);
                    int y2Int = Convert.ToInt32(y2);

                    cityLabel = new Label();
                    cityLabel.Location = new Point(x2Int - 20, y2Int - 7);
                    cityLabel.Text = "City " + _cityArray[xy2].id;
                    cityLabel.BackColor = System.Drawing.Color.Green;
                    cityLabel.AutoSize = true;
                    cityLabel.MaximumSize = new Size(45, 15);
                    this.Controls.Add(cityLabel);   //Draw Label in application
